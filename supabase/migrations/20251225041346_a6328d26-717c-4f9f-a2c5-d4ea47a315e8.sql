DROP FUNCTION IF EXISTS public.apply_player_diamond_delta(uuid, integer);
...
BEGIN
  ...
  -- Upsert daily stats using explicit table reference
  ...
  RETURN QUERY SELECT p_player_id AS player_id, v_old AS old_diamonds, v_new AS new_diamonds;
END;
$function$;